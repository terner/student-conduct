---
name: agent-2-scores
description: Score Module — บันทึกคะแนน, จัดการหมวดหมู่, timeline chart ทำงานบน agent/2-scores branch
...
## ภารกิจ
สร้าง Score Module (9 ไฟล์) บน branch `agent/2-scores`
...
### Pages (2 ไฟล์)
- `app/(dashboard)/score/record/page.tsx` — Score record
- `app/(dashboard)/score/categories/page.tsx` — Categories

## กฎ
- Recharts สำหรับ timeline
- Evidence upload ใช้ Supabase Storage
